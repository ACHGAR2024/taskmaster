                ...
                <div class="px-6 py-8">
                    <div class="container flex justify-between mx-auto">
                        <div class="max-w-4xl px-10 py-6 mx-auto bg-white  shadow-md  bg-vertp rounded-md">
                            ...
                            <!-- Blog Post Loop -->
                            <img src="https://picsum.photos/700/500?random={{ $blog->id }}" alt="Random Image 1"
                                class="w-full h-64  rounded-t-l object-cover">
                                ...
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                    <div class="p-6 bg-white border-b border-gray-200">
                                        ...
                                        <form action="{{ route('blogs.destroy', $blog->id) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="px-6 py-2 text-blancp bg-rougep rounded hover:bg-vertp">
                                                {{ __('Supprimer mon post') }}
                                            </button>
                                        </form>
