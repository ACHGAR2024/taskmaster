                            ...
                            <form action="{{ route('blogs.update', $blog) }}" method="post"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="text-noirp border-2 border-gray-300 p-2 w-full"
                                        name="title" id="title" value="{{ $blog->title }}" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="text-xl text-gray-600">Description
                                        <span class="text-red-500">*</span></label></br>
                                    <textarea class="text-noirp border-2 border-gray-300 p-2 w-full" name="content">{{ $blog->content }}</textarea>
                                </div>
                                <button type="submit"
                                    class="px-3 py-1 bg-vertp hover:bg-bleup rounded-md text-white hover:bg-red-400">Modifier</button>
