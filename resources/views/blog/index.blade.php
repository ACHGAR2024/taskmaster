                ...
                <footer class="bg-gray-800 dark:bg-gray-900">
                    <div class="mx-auto w-full max-w-screen-xl">
                        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                            <div>
                                <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Entreprise
                                </h2>
                            ...
                            <div>
                                <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Centre
                                    d'aide</h2>
                                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                    <li class="mb-4">
                        ...
                        <div class="px-4 py-6 bg-black dark:bg-gray-900 md:flex md:items-center md:justify-between">
                            <span class="text-sm text-gray-400 dark:text-gray-300 sm:text-center">© 2024 <a
                                    href="https://flowbite.com/">Laravel Vite Tailwind Flowbite™</a>. All Rights
                                Reserved.
                            </span>
