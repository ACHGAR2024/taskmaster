                ...
                <div id="text"
                    ...
                    <div class="text-right">
                        <a href="{{ route('blog.index') }}"
                            class="bg-vertp right-0  border-solid border-2 border-bleup hover:bg-grisp hover:text-white drop-shadow-lg text-blancp font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">Visiter
                        </a>
                    </div>
                </div>
            </section>
