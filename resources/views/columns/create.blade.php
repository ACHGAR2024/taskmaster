    ...
    <div class="min-h-screen bg-slate-900 dark:bg-gray-900">
        ...
        <main class="bg-grisp h-screen">
            <div class="container mx-auto p-4">
                <h1 class="text-2xl font-bold mb-4 text-blancp">Créer une Nouvelle Colonne</h1>
                ...
                <form action="{{ route('columns.store') }}" method="POST"
                    ...
                    @csrf
                    <div class="mb-4 ">
                        <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Nom de la
                            Colonne</label>
                        <input type="text"
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit"
                            class="bg-bleup hover:bg-grisp text-blancp font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Créer</button>
                    </div>
                </form>
            </div>
        </main>
