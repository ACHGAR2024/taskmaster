<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full text-noirp" type="email" name="email"
        ...
        <div class="flex items-center justify-end mt-4">
            <div>
                <button
                    class="bg-vertp hover:bg-rougep text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
